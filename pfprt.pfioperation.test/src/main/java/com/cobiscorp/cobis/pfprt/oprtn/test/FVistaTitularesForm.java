...
public class FVistaTitularesForm{
	...
	private FVistaTitularesForm() {
		throw new IllegalStateException("FVistaTitularesForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand2IdCMTPFPRTMQFFB cmdCommand2IdCMTPFPRTMQFFB = Singleton.getInstance(CmdCommand2IdCMTPFPRTMQFFB.class);
		
		public static class CmdCommand2IdCMTPFPRTMQFFB extends COBISButton{
			public CmdCommand2IdCMTPFPRTMQFFB () {
				this.init("CM_TPFPRTMQ_FFB", "Siguiente");
			}
		}
