...
public class FVistaPagoForm{
	...
	private FVistaPagoForm() {
		throw new IllegalStateException("FVistaPagoForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand1IdCMTPFPRTYPT77 cmdCommand1IdCMTPFPRTYPT77 = Singleton.getInstance(CmdCommand1IdCMTPFPRTYPT77.class);
		
		public static class CmdCommand1IdCMTPFPRTYPT77 extends COBISButton{
			public CmdCommand1IdCMTPFPRTYPT77 () {
				this.init("CM_TPFPRTYP_T77", "Anterior");
			}
		}
	
		public static final CmdCommand3IdCMTPFPRTYPTRT cmdCommand3IdCMTPFPRTYPTRT = Singleton.getInstance(CmdCommand3IdCMTPFPRTYPTRT.class);
		
		public static class CmdCommand3IdCMTPFPRTYPTRT extends COBISButton{
			public CmdCommand3IdCMTPFPRTYPTRT () {
				this.init("CM_TPFPRTYP_TRT", "Siguiente");
			}
		}
	
		public static final CmdCommand3IdCMTPFPRTYP273 cmdCommand3IdCMTPFPRTYP273 = Singleton.getInstance(CmdCommand3IdCMTPFPRTYP273.class);
		
		public static class CmdCommand3IdCMTPFPRTYP273 extends COBISButton{
			public CmdCommand3IdCMTPFPRTYP273 () {
				this.init("CM_TPFPRTYP_273", "Guardar");
			}
		}
