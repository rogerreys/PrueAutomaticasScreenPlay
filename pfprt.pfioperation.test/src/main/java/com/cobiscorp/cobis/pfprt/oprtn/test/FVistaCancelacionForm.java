...
public class FVistaCancelacionForm{
	...
	private FVistaCancelacionForm() {
		throw new IllegalStateException("FVistaCancelacionForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand2IdCMTPFPRTXOQR0 cmdCommand2IdCMTPFPRTXOQR0 = Singleton.getInstance(CmdCommand2IdCMTPFPRTXOQR0.class);
		
		public static class CmdCommand2IdCMTPFPRTXOQR0 extends COBISButton{
			public CmdCommand2IdCMTPFPRTXOQR0 () {
				this.init("CM_TPFPRTXO_QR0", "Anterior");
			}
		}
	
		public static final CmdCommand1IdCMTPFPRTXO7N cmdCommand1IdCMTPFPRTXO7N = Singleton.getInstance(CmdCommand1IdCMTPFPRTXO7N.class);
		
		public static class CmdCommand1IdCMTPFPRTXO7N extends COBISButton{
			public CmdCommand1IdCMTPFPRTXO7N () {
				this.init("CM_TPFPRTXO__7N", "Siguiente");
			}
		}
	
		public static final CmdCommand3IdCMTPFPRTXOOPF cmdCommand3IdCMTPFPRTXOOPF = Singleton.getInstance(CmdCommand3IdCMTPFPRTXOOPF.class);
		
		public static class CmdCommand3IdCMTPFPRTXOOPF extends COBISButton{
			public CmdCommand3IdCMTPFPRTXOOPF () {
				this.init("CM_TPFPRTXO_OPF", "Solicitar Autorización");
			}
		}
