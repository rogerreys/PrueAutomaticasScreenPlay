...
public class FVistaOperacionForm{
	...
	private FVistaOperacionForm() {
		throw new IllegalStateException("FVistaOperacionForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand1IdCMTPFPRTCK5R cmdCommand1IdCMTPFPRTCK5R = Singleton.getInstance(CmdCommand1IdCMTPFPRTCK5R.class);
		
		public static class CmdCommand1IdCMTPFPRTCK5R extends COBISButton{
			public CmdCommand1IdCMTPFPRTCK5R () {
				this.init("CM_TPFPRTCK_5_R", "Anterior");
			}
		}
	
		public static final CmdCommand2IdCMTPFPRTCKKRJ cmdCommand2IdCMTPFPRTCKKRJ = Singleton.getInstance(CmdCommand2IdCMTPFPRTCKKRJ.class);
		
		public static class CmdCommand2IdCMTPFPRTCKKRJ extends COBISButton{
			public CmdCommand2IdCMTPFPRTCKKRJ () {
				this.init("CM_TPFPRTCK_KRJ", "Siguiente");
			}
		}
	
		public static final CmdCommand3IdCMTPFPRTCKTF3 cmdCommand3IdCMTPFPRTCKTF3 = Singleton.getInstance(CmdCommand3IdCMTPFPRTCKTF3.class);
		
		public static class CmdCommand3IdCMTPFPRTCKTF3 extends COBISButton{
			public CmdCommand3IdCMTPFPRTCKTF3 () {
				this.init("CM_TPFPRTCK_TF3", "Guardar");
			}
		}
