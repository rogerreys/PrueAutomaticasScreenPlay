...
public class FVistaRenovacionForm{
	...
	private FVistaRenovacionForm() {
		throw new IllegalStateException("FVistaRenovacionForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand1IdCMTPFPRTGALLT cmdCommand1IdCMTPFPRTGALLT = Singleton.getInstance(CmdCommand1IdCMTPFPRTGALLT.class);
		
		public static class CmdCommand1IdCMTPFPRTGALLT extends COBISButton{
			public CmdCommand1IdCMTPFPRTGALLT () {
				this.init("CM_TPFPRTGA_LLT", "Anterior");
			}
		}
	
		public static final CmdCommand2IdCMTPFPRTGAP9T cmdCommand2IdCMTPFPRTGAP9T = Singleton.getInstance(CmdCommand2IdCMTPFPRTGAP9T.class);
		
		public static class CmdCommand2IdCMTPFPRTGAP9T extends COBISButton{
			public CmdCommand2IdCMTPFPRTGAP9T () {
				this.init("CM_TPFPRTGA_P9T", "Siguiente");
			}
		}
	
		public static final CmdCommand3IdCMTPFPRTGA19P cmdCommand3IdCMTPFPRTGA19P = Singleton.getInstance(CmdCommand3IdCMTPFPRTGA19P.class);
		
		public static class CmdCommand3IdCMTPFPRTGA19P extends COBISButton{
			public CmdCommand3IdCMTPFPRTGA19P () {
				this.init("CM_TPFPRTGA_19P", "Guardar");
			}
		}
	
		public static final CmdCommand4IdCMTPFPRTGAT3R cmdCommand4IdCMTPFPRTGAT3R = Singleton.getInstance(CmdCommand4IdCMTPFPRTGAT3R.class);
		
		public static class CmdCommand4IdCMTPFPRTGAT3R extends COBISButton{
			public CmdCommand4IdCMTPFPRTGAT3R () {
				this.init("CM_TPFPRTGA_T3R", "Solicitar Autorización");
			}
		}
