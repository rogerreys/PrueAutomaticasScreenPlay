...
public class FVistaPagoCapitalForm{
	...
	private FVistaPagoCapitalForm() {
		throw new IllegalStateException("FVistaPagoCapitalForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand1IdCMTPFPRTMVTFT cmdCommand1IdCMTPFPRTMVTFT = Singleton.getInstance(CmdCommand1IdCMTPFPRTMVTFT.class);
		
		public static class CmdCommand1IdCMTPFPRTMVTFT extends COBISButton{
			public CmdCommand1IdCMTPFPRTMVTFT () {
				this.init("CM_TPFPRTMV_TFT", "Anterior");
			}
		}
	
		public static final CmdCommand2IdCMTPFPRTMVP4T cmdCommand2IdCMTPFPRTMVP4T = Singleton.getInstance(CmdCommand2IdCMTPFPRTMVP4T.class);
		
		public static class CmdCommand2IdCMTPFPRTMVP4T extends COBISButton{
			public CmdCommand2IdCMTPFPRTMVP4T () {
				this.init("CM_TPFPRTMV_P4T", "Guardar");
			}
		}
